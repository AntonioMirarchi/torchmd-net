...
def get_argparse():
    ...
    parser.add_argument('--output-mlp-bias-on-last-layer', type=bool, default=True, help='If the output model uses an MLP, this decides whether the last layer has a bias or not.')
